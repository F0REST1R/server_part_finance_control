...
const (
	...
	AuthService_LoginVK_FullMethodName       = "/auth.AuthService/LoginVK"
)
...
type AuthServiceClient interface {
	...
	LoginVK(ctx context.Context, in *VKAuthRequest, opts ...grpc.CallOption) (*AuthResponse, error)
}
...
func (c *authServiceClient) LoginVK(ctx context.Context, in *VKAuthRequest, opts ...grpc.CallOption) (*AuthResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AuthResponse)
	err := c.cc.Invoke(ctx, AuthService_LoginVK_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	LoginVK(context.Context, *VKAuthRequest) (*AuthResponse, error)
...
func (UnimplementedAuthServiceServer) LoginVK(context.Context, *VKAuthRequest) (*AuthResponse, error) {
...
func _AuthService_LoginVK_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_LoginVK_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).LoginVK(ctx, req.(*VKAuthRequest))
	}
	return interceptor(ctx, in, info, handler)
}
